...
class server():
    ...
    def run(self):
        ...
        while True:
            ...
            if conn:
                ...
                threading.Thread(target=self.manage_client, args=(sock_ssh, conn)).start()
                threading.Thread(target=self.manage_client_2, args=(sock_ssh,conn)).start()
    def copy_streams(self, source, destination):
        try:
            ...
            source.close()
            destination.close()
    def manage_client(self,sock_ssh,conn):
                    ...
                    threading.Thread(target=self.copy_streams, args=(sock_ssh, conn)).start()
    def manage_client_2(self,sock_ssh,conn):
                    threading.Thread(target=self.copy_streams, args=(conn, sock_ssh)).start()
                    threading.Thread(target=self.copy_streams, args=(sock_ssh, conn)).start()
                    threading.Thread(target=self.copy_streams, args=(conn, sock_ssh)).start()
